...
CREATE TABLE IF NOT EXISTS `tb_proposta` (
  ...
  `PROPOSTA_TEXTO` varchar(255) NOT NULL,
...
-- DADOS DE TRABALHO
INSERT INTO `freelatech`.`tb_trabalho` (`ID`, `TITULO`, `DESCRICAO`, `ORCAMENTO`, `TIPO`, `EXPERIENCIA`, `CATEGORIA_ID`, `AUTOR_ID`) VALUES ('1', 'Desenvolvedor Python', 'Lorem ipsum', '1000.00', 'FIXO', 'INICIANTE', '1', '1');
